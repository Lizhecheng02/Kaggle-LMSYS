...
def adjust(current_lengths, prompt_length_space=400, response_length_space=1000):
...
def train(args):
    ...
    ### process dataset 
    config = AutoConfig.from_pretrained(MODEL, trust_remote_code=True, token="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")
    tokenizer = AutoTokenizer.from_pretrained(MODEL, trust_remote_code=True, truncation_side = 'left', token="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")
